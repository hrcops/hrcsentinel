...
def make_interactives(telem_start, time_zero, old_telem=None):
    ...
    fig.add_annotation(x=4.4, y=26,
                       text="End",
                       showarrow=False)

    out_html_file = '/Users/grant/Desktop/cap1636_plotly_voltages.html'
    ...
    out_html_file = '/Users/grant/Desktop/cap1636_plotly_temperatures.html'
