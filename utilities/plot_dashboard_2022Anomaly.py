...
# HRCSentinel stuff
import plot_stylers
from chandratime import (calc_time_to_next_comm, cxctime_to_datetime,
                         convert_to_doy)
        ...
        for j in range(4):
            ...
            if missionwide is False:
                ...
                if plotnum == 11:
                    ...
                    ax_resets.plot_date(cxctime_to_datetime(format_changes['CCSDSTMF'].times), format_changes['CCSDSTMF'].vals, linestyle='solid',
