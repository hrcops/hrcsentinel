...
# HRCSentinel stuff
import plot_stylers
from chandratime import (calc_time_to_next_comm, convert_chandra_time_legacy,
                         convert_to_doy)
        ...
        for j in range(4):
            ...
            if missionwide is False:
                ...
                if plotnum == 11:
                    ...
                    ax_resets.plot_date(convert_chandra_time_legacy(format_changes['CCSDSTMF'].times), format_changes['CCSDSTMF'].vals, linestyle='solid',
...
def parse_args():
    ...
    argparser.add_argument('--separate_plots', action='store_true')

    argparser.add_argument('--date_format', default='%D %H')
...
def main():
    ...
    make_realtime_plot(plot_start=plot_start, plot_stop=plot_stop,
                       current_hline=False, sampling=args.sampling, date_format=mdate.DateFormatter(args.date_format), force_limits=args.force_limits, show_in_gui=True, use_cheta=args.use_cheta, separate_plots=args.separate_plots)
