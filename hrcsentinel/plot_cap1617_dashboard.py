...
def update_plot(telem_start, time_zero, iteration_count, old_telem=None, save_path=None, monitor=False):
    ...
    for ax in [ax1, ax2]:
        ...
        obs_start = CxoTime('2022:186:21:39:43').secs - time_zero.secs
        maneuver = CxoTime('2022:186:21:06:20').secs - time_zero.secs

        comm_end = CxoTime('2022:187:00:00:00').secs - time_zero.secs
    ...
    if save_path is not None:
        ...
        if monitor is True:
            scp_file_to_hrcmonitor(
                file_to_scp=save_path, destination='/proj/web-icxc/htdocs/hrcops/hrcmonitor/plots/cap1617.png')
...
def main():
    ...
    telem_start = '2022:186'
    # time_zero = CxoTime.now()  # fake for testing
    time_zero = CxoTime('2022:186:21:00')  # CAP start
    iteration_count = 0
    ...
    while True:
        ...
        if args.monitor is True:
            save_path = f'/Users/grant/Desktop/cap1617_plots/{iteration_count}_dashboard.png'
