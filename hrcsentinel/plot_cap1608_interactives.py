...
def make_interactives(telem_start, time_zero, old_telem=None):
    ...
    fig.add_vline(x=3.32, line_width=1, line_color="gray")

    fig.add_annotation(x=3.32, y=-5,
                       text="Deadman",
                       showarrow=False)

    out_html_file = '/Users/grant/Desktop/cap1608_plotly_voltages.html'
    ...
    fig2.add_vline(x=3.32, line_width=1, line_color="gray")

    fig2.add_annotation(x=3.32, y=-5,
                        text="Deadman",
                        showarrow=False)
    ...
    out_html_file = '/Users/grant/Desktop/cap1608_plotly_temperatures.html'
